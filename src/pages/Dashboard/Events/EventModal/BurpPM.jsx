...
function BurpPM(props) {
  const { openBurpModal, setOpenBurpModal, handleSave, questionId } = props;

  let [count, setCount] = useState(0);
  const text = "Gas coming out from the mouth";
  let increaseValue = () => {
    setCount((count += 1));
  };
      ...
      <div className={styles.modalBckg}>
        <div className={styles.modalContainer}>
          ...
          <div className={styles.symtMainTextSec}>
            <h4 className={styles.mainText1}>Burping</h4>
          </div>
          ...
          <div className={styles.imgPainSec}>
            <img src={Burp} className={styles.imageStymp} alt="" />
          </div>
