...
import Stomachburn from "./Images/stomachburn.png";
...
function StomachburnPM(props) {
  const {
    openStomachburnModal,
    setOpenStomachburnModal,
    handleSave,
    previousAnswer,
    questionId,
  } = props;
  ...
  if (!openStomachburnModal) return null;
  const text = " An uncomfortable burning feeling above your belly button";
  return (
    <>
      <div className={styles.modalBckg}>
        <div className={styles.modalContainer}>
          ...
          <div className={styles.symtMainTextSec}>
            <h4 className={styles.mainText1}>Stomach Burn</h4>
          </div>
          ...
          <div className={styles.imgPainSec}>
            <img src={Stomachburn} className={styles.imageStymp} alt="" />
