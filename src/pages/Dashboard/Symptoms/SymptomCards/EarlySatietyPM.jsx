...
import ExSatiety from "./Images/ESatiety.png";
...
function EarlySatietyPM(props) {
  const {
    openESatietyModal,
    setOpenESatietyModal,
    handleSave,
    previousAnswer,
    questionId,
  } = props;
  ...
  if (!openESatietyModal) return null;
      ...
      <div className={styles.modalBckg}>
        <div className={styles.modalContainer}>
          ...
          <div className={styles.symtMainTextSec}>
            <h4 className={styles.mainText1}>Full Early</h4>
          </div>
          ...
          <div className={styles.imgPainSec}>
            <img src={ExSatiety} className={styles.imageStymp} alt="" />
