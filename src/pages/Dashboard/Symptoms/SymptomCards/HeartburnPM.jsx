...
import HeartB from "./Images/heartburn.png";
...
function HeartburnPM(props) {
  ...
  if (!openHBModal) return null;
  const text = " An uncomfortable burning feeling in your chest or throat";
  return (
    <>
      <div className={styles.modalBckg}>
        <div className={styles.modalContainer}>
          ...
          <div className={styles.symtMainTextSec}>
            <h4 className={styles.mainText1}>Heartburn</h4>
          </div>
          ...
          <div className={styles.imgPainSec}>
            <img src={HeartB} className={styles.imageStymp} alt="" />
