...
function NauseaPM(props) {
  ...
  if (!openNauseaModal) return null;
  const text = "Feeling sick like you might need to throw up.";
  return (
    <>
      <div className={styles.modalBckg}>
        <div className={styles.modalContainer}>
          ...
          <div className={styles.symtMainTextSec}>
            <h4 className={styles.mainText1}>Nausea</h4>
          </div>
          ...
          <div className={styles.imgPainSec}>
            <img src={Nausea} className={styles.imageStymp} alt="" />
