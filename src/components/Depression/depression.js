...
export default function Depression({ participant, day, testDay }) {
  ...
  useEffect(() => {
    const ratingValue = Cookies.get("depression");
    if (ratingValue) {
      setValue(ratingValue);
    }
  }, []);
  const handleFinish = async () => {
    Cookies.set("depression", value);
      ...
      <div className={styles.mainContainer}>
        <div className={styles.innerMainContainer}>
          <div className={styles.innerContainer}>
            ...
            <div className={styles.sliderTextBot}>Sad</div>
          </div>
        </div>
